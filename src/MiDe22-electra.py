...
if __name__ == "__main__":
    ...
    config = AutoConfig.from_pretrained(os.path.join(output_dir, "electra-ANTiVax"), num_labels=3, problem_type="single_label_classification")

    tokenizer = AutoTokenizer.from_pretrained(os.path.join(output_dir, "electra-ANTiVax"), use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained(os.path.join(output_dir, "electra-ANTiVax"),
    ...
    model.save_pretrained(os.path.join(output_dir, "electra-MiDe22"))
    tokenizer.save_pretrained(os.path.join(output_dir, "electra-MiDe22"))
