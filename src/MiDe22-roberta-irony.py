...
if __name__ == "__main__":
    ...
    config = AutoConfig.from_pretrained(os.path.join(output_dir, "roberta-irony-ANTiVax"), num_labels=3)

    tokenizer = AutoTokenizer.from_pretrained(os.path.join(output_dir, "roberta-irony-ANTiVax"), use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained(os.path.join(output_dir, "roberta-irony-ANTiVax"),
    ...
    model.save_pretrained(os.path.join(output_dir, "roberta-irony-MiDe22"))
    tokenizer.save_pretrained(os.path.join(output_dir, "roberta-irony-MiDe22"))
    ...
    plt.title("Confusion Matrix - MiDe22 Roberta-irony")
    plt.savefig("MiDe22_confusion_matrix_roberta_irony.png", dpi=300, bbox_inches='tight')
