...
training_args = TrainingArguments(
    output_dir=os.path.join(checkpoint_dir, "rda-2017-roberta-irony"),
    num_train_epochs=4,
...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-roberta-base-irony", num_labels=3, ignore_mismatched_sizes=True)
    ...
    checkpoints = [f.path for f in os.scandir(os.path.join(checkpoint_dir, "rda-2017-roberta-irony")) if f.is_dir() and "checkpoint" in f.name]
    ...
    model.save_pretrained(os.path.join(output_dir, "roberta-irony-rda-2017"))
    tokenizer.save_pretrained(os.path.join(output_dir, "roberta-irony-rda-2017"))
    ...
    plt.title("Confusion Matrix - RDA-2017 Roberta Irony")
    plt.savefig("rda-2017_confusion_matrix_roberta_irony.png", dpi=300, bbox_inches='tight')
