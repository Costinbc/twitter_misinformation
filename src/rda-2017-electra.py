...
checkpoint_dir = os.path.join(src_dir, "electra-results")
...
if __name__ == "__main__":
    ...
    cfg = AutoConfig.from_pretrained("google/electra-base-discriminator")
    cfg.num_labels = 3
    ...
    model = AutoModelForSequenceClassification.from_pretrained("google/electra-base-discriminator", config=cfg, ignore_mismatched_sizes=True)
    ...
    model.save_pretrained(os.path.join(output_dir, "electra-rda-2017"))
    tokenizer.save_pretrained(os.path.join(output_dir, "electra-rda-2017"))
    ...
    plt.title("Confusion Matrix - RDA-2017 Electra")
    plt.savefig(os.path.join(images_dir, "rda-2017_confusion_matrix_electra.png"), dpi=300, bbox_inches='tight')

    Evaluation
    metrics: {'eval_loss': 0.5825706720352173, 'eval_accuracy': 0.8108974358974359, 'eval_f1': 0.8011828213066603,
              'eval_runtime': 0.2596, 'eval_samples_per_second': 1201.95, 'eval_steps_per_second': 38.524, 'epoch': 4.0}
