...
checkpoint_dir = os.path.join(src_dir, "twhin-bert-results")
...
if __name__ == "__main__":
    ...
    config = AutoConfig.from_pretrained(os.path.join(output_dir, "twhin-bert-rda-2017"), num_labels=2, problem_type="single_label_classification")

    tokenizer = AutoTokenizer.from_pretrained(os.path.join(output_dir, "twhin-bert-rda-2017"), use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained(os.path.join(output_dir, "twhin-bert-rda-2017"),
    ...
    model.save_pretrained(os.path.join(output_dir, "twhin-bert-ANTiVax"))
    tokenizer.save_pretrained(os.path.join(output_dir, "twhin-bert-ANTiVax"))
