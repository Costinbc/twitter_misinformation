...
if __name__ == "__main__":
    ...
    config = AutoConfig.from_pretrained(os.path.join(output_dir, "twhin-bert-ANTiVax"), num_labels=3, problem_type="single_label_classification")

    tokenizer = AutoTokenizer.from_pretrained(os.path.join(output_dir, "twhin-bert-ANTiVax"), use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained(os.path.join(output_dir, "twhin-bert-ANTiVax"),
    ...
    model.save_pretrained(os.path.join(output_dir, "twhin-bert-MiDe22"))
    tokenizer.save_pretrained(os.path.join(output_dir, "twhin-bert-MiDe22"))
