...
if __name__ == "__main__":
    ...
    cfg = AutoConfig.from_pretrained("Twitter/twhin-bert-base")
    cfg.num_labels = 3
    cfg.problem_type = "single_label_classification"

    tokenizer = AutoTokenizer.from_pretrained("Twitter/twhin-bert-base", use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained("Twitter/twhin-bert-base", config=cfg, ignore_mismatched_sizes=True)
    ...
    model.save_pretrained(os.path.join(output_dir, "twhin-bert-rda-2017"))
    tokenizer.save_pretrained(os.path.join(output_dir, "twhin-bert-rda-2017"))
